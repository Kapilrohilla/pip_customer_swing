...
public class ModifyPosition extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Modify Position #");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String stopLoss = jTextField1.getText();
        String takeProfit = jTextField2.getText();
        try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModifyPosition.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
//                new ModifyPosition().setVisible(true);
            }
        });
    }
